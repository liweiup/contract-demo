...
public class HbdmRestApiV1 implements IHbdmRestApi {
	...
	public static final String API_KEYs = "6c237587-frbghq7rnm-7f4ad2e2-8f66c";
	public static final String SECRET_KEY = "5cf21ef1-5a8e316b-da548507-3d133";
	public static final String HUOBI_API_URL = "https://dm.huobi.vc";
	...
	public static final String HUOBI_TRADE = "/market/trade";
	...
	//新增
	// 精英多空账户数
	public static final String HUOBI_FUTURE_ELITE_ACCOUNT_RATIO = "/api/v1/contract_elite_account_ratio";
	// 精英多空持仓量对比
	public static final String HUOBI_FUTURE_ELITE_POSITION_RATIO = "/api/v1/contract_elite_position_ratio";
	// 基差信息
	public static final String HUOBI_FUTURE_CONTRACT_HISBASIS = "/index/market/history/basis";
	//基差信息all
	public static final String HUOBI_FUTURE_CONTRACT_HISBASIS_ALL = "/index/market/history/basis/all";
	//持仓信息
	public static final String HUOBI_FUTURE_CONTRACT_ACCOUNT_POSITION_INFO = "/api/v1/contract_account_position_info";
	...
	public String futureMarketDetailTrade(String symbol, String size) throws HttpException, IOException {
		...
		String res = HbdmHttpClient.getInstance().doGet(url_prex + HUOBI_TRADE, params);
		return res;
	}
	...
	public String futureContractEliteAccountRatio(String symbol,String period)
		...
		String accountRation = HbdmHttpClient.getInstance().doGet(url_prex + HUOBI_FUTURE_ELITE_ACCOUNT_RATIO,
				params);
	...
	public String futureContractElitePositionRatio(String symbol,String period)
		...
		String positionRatio = HbdmHttpClient.getInstance().doGet(url_prex + HUOBI_FUTURE_ELITE_POSITION_RATIO,
				params);
	...
	public String futureContractHisbasis(String symbol,String period,String basis_price_type,String size)
		...
		if (!StringUtils.isEmpty(basis_price_type)) {
			params.put("basis_price_type",basis_price_type);
		}
		if (!StringUtils.isEmpty(size)) {
			params.put("size",size);
		}
		String hisBasis = HbdmHttpClient.getInstance().doGet(url_prex + HUOBI_FUTURE_CONTRACT_HISBASIS,
				params);
		return hisBasis;
	}
	...
	public String futureContractHisbasisAll(String symbol,String period,String basis_price_type,String size)
		...
		String hisBasis = HbdmHttpClient.getInstance().doGet(url_prex + HUOBI_FUTURE_CONTRACT_HISBASIS_ALL,
				params);
		return hisBasis;
	}

	@Override
	public String futureContractAccountPositionInfo(String symbol) throws HttpException, IOException {
		Map<String,String> params = new HashMap<>();
		if (!StringUtils.isEmpty(symbol)) {
			params.put("symbol", symbol);
		}
		String res = HbdmHttpClient.getInstance().call(api_key, secret_key, "POST",
				url_prex + HUOBI_FUTURE_CONTRACT_ACCOUNT_POSITION_INFO, params, new HashMap<>());
		return res;
	}
}

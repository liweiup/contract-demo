...
public class HbdmClient {
	...
	public static void main(String[] args) throws HttpException, IOException {
		 ...
		 */
		String api_key = "6c237587-frbghq7rnm-7f4ad2e2-8f66c"; // huobi申请的apiKey,API调试过程中有问题或者有疑问可反馈微信号shaoxiaofeng1118
		String secret_key = "5cf21ef1-5a8e316b-da548507-3d133"; // huobi申请的secretKey
